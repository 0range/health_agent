...
_ANALYTES = (
    ...
    ("mcv", "MCV|Средний объем эритроцита|Средний объём эритроцита", "fL"),
    ("mch", "MCH|Среднее содержание гемоглобина", "pg"),
    ("mchc", "MCHC|Средняя концентрация гемоглобина", "g/L|g/dL"),
    ("rdw", "RDW|RDW-CV", "%"),
    ("mpv", "MPV|Средний объем тромбоцита", "fL"),
