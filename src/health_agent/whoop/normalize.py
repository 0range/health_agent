...
def normalize_whoop(resource_kind: str, payload: dict[str, Any]) -> NormalizedWhoopRecord:
    normalizers = {
...
def _normalize_cycle(
    ...
    return external_id, _datetime(payload.get("updated_at")), {
...
def _normalize_sleep(
    ...
    return external_id, _datetime(payload.get("updated_at")), {
        ...
        "sleep_debt_needed_milli": _integer(needed.get("need_from_sleep_debt_milli")),
        "strain_needed_milli": _integer(needed.get("need_from_recent_strain_milli")),
