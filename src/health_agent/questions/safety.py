...
URGENT_RESPONSE = (
    ...
    "экстренной помощи (например, 112) или обратитесь в ближайшее отделение неотложной "
    "помощи — не ждите ответа онлайн. Если это безопасно, попросите кого-то быть рядом "
    "с вами."
)
