...
_PATH_DEFAULTS = {
    ...
    "GOOGLE_DRIVE_ROOT": "data/google-drive",
    "GOOGLE_DRIVE_CLIENT_SECRETS": "data/secrets/google-drive-oauth-client.json",
    "GOOGLE_SHEETS_ROOT": "data/google-sheets",
    "GOOGLE_SHEETS_CLIENT_SECRETS": "data/secrets/google-oauth-client.json",
    "GOOGLE_CALENDAR_ROOT": "data/google-calendar",
    "GOOGLE_CALENDAR_CLIENT_SECRETS": "data/secrets/google-oauth-client.json",
    "AUTOMATION_ROOT": "data/automation",
    "OPENAI_API_KEY_FILE": ".tokens/openai-api-key",
...
_DIRECTORY_KEYS = {
    "GOOGLE_DRIVE_ROOT", "GOOGLE_SHEETS_ROOT", "GOOGLE_CALENDAR_ROOT", "AUTOMATION_ROOT",
    "VAULT_ROOT",
    "TEMPORARY_ROOT",
...
_REQUIRED_KEYS = {
    "GOOGLE_DRIVE_ROOT", "GOOGLE_DRIVE_CLIENT_SECRETS",
    "GOOGLE_SHEETS_ROOT", "GOOGLE_SHEETS_CLIENT_SECRETS",
    "GOOGLE_CALENDAR_ROOT", "GOOGLE_CALENDAR_CLIENT_SECRETS", "AUTOMATION_ROOT",
    "OPENAI_API_KEY_FILE", "YANDEX_API_KEY_FILE",
    "CONNECTOR_STATE_ROOT",
    "GMAIL_ROOT",
